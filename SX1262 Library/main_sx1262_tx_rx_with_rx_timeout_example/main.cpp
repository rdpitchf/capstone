...
void set_radio_configuration_default(bool lora_or_fsk){
  ...
  if(using_lora == 1){
    set_rx_settings_lora(2, 10, 1, 0, 4, 1, true, 255, false, true, 1, false, false);
    set_tx_settings_lora(14, 0, 2, 10, 1, 12, true, false, true, 1, false, 10000);
    radio.set_rx_timeout_us(20000000);
    ...
    radio.set_rx_config(modem, rx_bandwidth, rx_datarate, rx_coderate, rx_bandwidth_afc, rx_preamble_len, rx_symb_timeout, rx_fix_len, rx_payload_len, rx_crc_on, rx_freq_hop_on, rx_hop_period, rx_iq_inverted, false);
